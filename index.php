         ...
         <section class="home section" id="home">
            <div class="home__container container">
                <div class="home__info">
                        <h1 class="home__title">Hola,<br> It's yo' girl,<br> <span>Psalm Ashley</span>
                        </h1>
                        <p class="home__description">
                            A passionate <span>student-athlete</span> from NU-Lipa
                        </p>
                        <a href="#" class="home__button"></a>
                    </div>

                <div class="home__group">
                    <div class="home__images">
                        <div class="home__img-me">
                            <img src="./psalmey.png" alt="home image" class="home__img-me">
                            </div>
                        </div>
                    </div>
            ...
            <!-- <div class="about_container">
                <div class="slide">
                    <div class="item" style="background-image: url();">
                        <div class="content">
                            <div class="name">Psalm Ashley Andal</div>
                            <div class="des"></div>
                    ...
                    <div class="item" style="background-image: url(img/nu.png);">
                        <div class="content">
                            <div class="name">National University - Lipa</div>
                            <div class="des"></div>
                            <button>See More</button>
                        </div>
                    </div>
